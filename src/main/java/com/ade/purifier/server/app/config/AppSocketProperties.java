package com.ade.purifier.server.app.config;
...
public class AppSocketProperties {
    ...
    private final static Logger logger = (Logger) LoggerFactory.getLogger(AppSocketProperties.class);

    private final static String FILE_NAME = "/app_socket.properties";
    ...
    private static void initialize() {
        ...
        InputStream in = null;
        try {
            in = AppSocketProperties.class.getResourceAsStream(FILE_NAME);
            Properties properties = new Properties();
            properties.load(in);
            VALUE_SERVER_PORT              = Integer.parseInt(properties.getProperty(KEY_SERVER_PORT, "8097"));
